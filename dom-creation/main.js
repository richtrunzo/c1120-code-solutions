...
function renderPokemon(pokemon) {
  ...
  var pokeGraf = document.createElement("p");
  var pokeGrafText = document.createTextNode(pokemon.description);
  pokeGraf.appendChild(pokeGrafText);
  ...
  pokemonText.appendChild(pokeGraf);
  return columnThird;
}
...
for(i = 0; i < pokedex.length; i++) {
  ...
  rowElement.appendChild(returnValue);
}
